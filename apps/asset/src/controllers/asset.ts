...
import { sendSuccessResponse, CustomError, statusCode, asset as assetMsg } from "@dam/shared";
...
export const upload = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
  try {
    ...
    sendSuccessResponse({ res, statusCode: statusCode.successCreated, message: assetMsg.createSuccess, data: result });
  } catch (error) {
    return next(error);
  }
};
...
export const getById = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
  try {
    ...
    if (result instanceof CustomError) return next(result);
    sendSuccessResponse({ res, statusCode: statusCode.success, message: assetMsg.getSuccess, data: result });
  } catch (error) {
    return next(error);
  }
};
...
export const update = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
  try {
    ...
    if (result instanceof CustomError) return next(result);
    sendSuccessResponse({ res, statusCode: statusCode.success, message: assetMsg.updateSuccess, data: result });
  } catch (error) {
    return next(error);
  }
};
...
export const transitionStatus = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
  try {
    ...
    if (result instanceof CustomError) return next(result);
    sendSuccessResponse({ res, statusCode: statusCode.success, message: assetMsg.statusUpdateSuccess, data: result });
  } catch (error) {
    return next(error);
  }
};

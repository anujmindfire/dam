...
import { Lock, Mail, User, ArrowRight, ShieldPlus } from "lucide-react";
      ...
      >
        ...
        >
          ...
          <div className="text-center mb-10">
            ...
            >
              <ShieldPlus className="text-white w-10 h-10" />
            </motion.div>
            <h1 className="text-4xl font-bold text-white mb-3 tracking-tight">Create Account</h1>
            <p className="text-text-muted text-lg font-light">Join the digital asset revolution</p>
          </div>
          ...
          {/* Footer */}
          {/* Note: the mt-10 here also acts as a gap, so combined with the h-8 above, this will be quite large. You can drop this mt-10 if you strictly want to control the gap with the spacer div above. */}
